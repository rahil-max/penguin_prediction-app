...
st.sidebar.title('Penguin Species Prediciton')
...
sex = st.sidebar.selectbox('Sex' , ('Male','Female')).map({'Male':0,'Female':1})
island = st.sidebar.selectbox('Island' , ('Biscoe' , 'Dream' , 'Torgersen')).map({'Biscoe': 0, 'Dream': 1, 'Torgersen':2})
model = st.sidebar.selectbox('Classification model' , ('RandomForestClassifier' , 'LogisticRegression' , 'Support Vector Machine'))
